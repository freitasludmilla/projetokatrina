...
?>
    ...
    <form action="?pagina=alterarEvento" method="post" class="" id="formularioEvento">
    ...
    required />
        ...
        type="hidden">
        <button type="submit" class="mt-3 btn btn-info align-center" name="">Salvar alteração</button>
